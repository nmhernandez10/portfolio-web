...
export const PROJECTS = [
  {
    ...
    description: 'Recording, transcription and post-session analysis were blocking the request path on a regulated mental health platform.',
    detail: [
  ...
  },
  {
    ...
    description: 'The team needed a consistent way to delegate work to coding agents and verify what came back.',
    detail: [
  ...
  },
  {
    ...
    description: 'A public REST API used by 50 to 200 partner stores a month, owned end to end.',
    detail: [
  ...
  },
  {
    ...
    description: 'Backend services and APIs for a platform used daily by 200+ restaurants across Colombia.',
    detail: [
...
export const EXPERIENCE = [
  {
    ...
    company: 'Keel Mind',
    summary: 'Lead technical design and delivery across backend, web, mobile and QA teams of four to eight engineers.',
    points: [
  ...
  },
  {
    ...
    company: 'Keel Mind',
    summary: 'Built backend services and administrative tooling for first responder, Indigenous, academic and education care programs.',
    points: [
  ...
  },
  {
    ...
    summary: 'Owned the public REST API used by 50 to 200 partner stores each month.',
    points: [
  ...
  },
  {
    ...
    company: 'Meniu',
    summary: 'Backend services and APIs for a platform used daily by 200+ restaurants across Colombia.',
    points: [
...
export const SKILLS = [
  { title: 'Backend', items: ['TypeScript', 'Node.js', 'NestJS', 'Fastify', 'Python', 'REST', 'GraphQL', 'Event-driven architecture'] },
  { title: 'Data', items: ['PostgreSQL', 'Relational modeling', 'Migrations', 'Query optimization', 'MongoDB', 'Redis', 'ETL'] },
  { title: 'Cloud & DevOps', items: ['AWS Lambda', 'SQS', 'S3', 'RDS', 'API Gateway', 'Fargate', 'Docker', 'CI/CD'] },
  { title: 'Observability', items: ['Elasticsearch', 'Kibana', 'Structured logging', 'Metrics', 'Alerting'] },
  { title: 'AI engineering', items: ['Claude Code', 'Codex CLI', 'AWS Bedrock', 'AgentCore', 'Context management', 'Automated review'] },
  { title: 'Practices', items: ['System design', 'Automated testing', 'Code review', 'Mentoring', 'Feature ownership'] },
];

export const EDUCATION = [
  { school: 'Universidad de los Andes', degree: 'BSc Systems & Computing Engineering', period: '2015 — 2019' },
