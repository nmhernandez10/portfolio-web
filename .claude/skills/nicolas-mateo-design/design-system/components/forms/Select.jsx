...
/** Native select in the system's field skin, with a Lucide chevron. */
export function Select({ label, hint, options = [], id, iconBase, style, ...rest }) {
  ...
  return (
    <label htmlFor={fieldId} style={{ display: "flex", flexDirection: "column", gap: "var(--space-2)", ...style }}>
      ...
      >
        ...
        <Icon name="chevron-down" size={16} {...(iconBase ? { base: iconBase } : {})} style={{ position: "absolute", right: 14, pointerEvents: "none" }} />
      </span>
