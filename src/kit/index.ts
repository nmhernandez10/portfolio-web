// The new design system, ported in-app from .claude/skills/nicolas-mateo-design.
// Import from "@/kit" rather than reaching into the group folders; internal.ts
// is the kit's private seam and is deliberately not re-exported.
//
// VC3 deletes src/ui/ and `git mv`s this directory into its place.
