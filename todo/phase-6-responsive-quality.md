...
1. **Responsive CSS** per the breakpoints above. Also verify at ~390px (modern phone): no horizontal scroll, the portrait crop keeps the face (`50% 20%` still sane), the ProjectBrief metrics rows wrap, form fields go full width.
